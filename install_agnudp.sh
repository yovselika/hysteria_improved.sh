...
echo "Optimizaciones adicionales..."
# Optimizaciones
echo "net.core.default_qdisc=fq" | sudo tee -a /etc/sysctl.conf
echo "net.ipv4.tcp_congestion_control=bbr" | sudo tee -a /etc/sysctl.conf 
sudo sysctl -p

# Deshabilitar UDP checksum offload
sudo ethtool -K eth0 rx-udp_tunnel-port-offload off

echo "Hysteria ha sido instalado y configurado con éxito."
